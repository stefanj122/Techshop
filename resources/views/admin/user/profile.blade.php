                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <div class="social-links mt-2">
                                <a href="https://twitter.com/jeftic122"target="_balnk" class="twitter"><i
                                        class="bi bi-twitter"></i></a>
                                <a href="https://www.facebook.com/stefanj3110/" target="_balnk" class="facebook"><i
                                        class="bi bi-facebook"></i></a>
                                <a href="https://www.instagram.com/stefanj3110/" target="_balnk" class="instagram"><i
                                        class="bi bi-instagram"></i></a>
                                <a href="#" target="_balnk" class="linkedin"><i class="bi bi-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9 text-center">
                                                <img src="{{ asset('storage/images/avatars/' . Auth::user()->avatar) }}"
                                                    alt="Profile" class="rounded-circle"id="output">
                                                <div class="pt-2">
                                                    <label class="bi bi-upload btn btn-secondary text-white" for="avatar">
                                                        Change image
                                                    </label>
                                                    <input type="file" class="bi bi-upload" name="avatar"
                                                        accept="image/*" id="avatar" style="display: none;" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="firstName" type="text" class="form-control"
                                                    id="firstName" value="{{ Auth::user()->firstName }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="lastName" type="text" class="form-control"
                                                    id="lastName" value="{{ Auth::user()->lastName }}">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form method="POST" action="{{ route('user.changePassword', Auth::user()->id) }}">
                                        @csrf
                                        @method('PATCH')
